...
텍스트 목록보다 흐름이 한눈에 보이도록, 이번 글에서 따라간 관찰 범위를 먼저 플로우 차트로 정리하면 아래와 같습니다.
...
즉, 이 글은 홈 전체를 다루는 문서라기보다,
**견적 요청 플로우가 어떻게 시작되고, 제출 이후 어떤 후속 화면과 종료 상태까지 이어지는지**를 따라간 관찰 기록에 가깝습니다.
